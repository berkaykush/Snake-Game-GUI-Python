...
class Button:
    ...
    def set_elevation(self, new_value):
    ...
    def draw(self, screen):
        ...
        pygame.draw.rect(screen, self.__bottom_rect_color,
                         self.__bottom_rect, border_radius=100)
        pygame.draw.rect(screen, self.__top_rect_color,
                         self.__top_rect, border_radius=100)

        screen.blit(self.__text_surface, self.__text_rect)

    def __eq__(self, other):
        return (isinstance(other, Button)) and (self.__name == other.get_name)
